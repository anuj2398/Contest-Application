...
public class ContestService{
    ...
    public List<Contestant> contestHistory(Long contestId) {
        ...
        // Collections.sort(contestantsList,new compareScoreDsc());
        ...
        return contestantsList.stream().sorted((c1,c2)-> c2.getCurrentContestPoints() - c1.getCurrentContestPoints()).collect(Collectors.toList());

    }  
}
class compareScoreDsc implements Comparator<Contestant>{
    @Override
